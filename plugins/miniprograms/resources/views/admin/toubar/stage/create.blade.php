...
@section('content')
    ...
    <div class="layout-2columns sidebar-right">
        <div class="column main">
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', WEBED_TOUBAR_STAGE, null) @endphp
        </div>
        <div class="column right">
            @include('webed-core::admin._components.form-actions')
            @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', WEBED_TOUBAR_STAGE, null) @endphp
            <div class="box box-primary">
                <div class="box-header with-border">
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'bottom-sidebar', WEBED_TOUBAR_STAGE, null) @endphp
        </div>
    </div>
    {!! Form::close() !!}
@endsection
