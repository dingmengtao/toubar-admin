...
class ShareController extends BaseAdminController
{
    ...
    public function getIndex(YourDataTables $dataTables)
    {
        ...
        return do_filter(BASE_FILTER_CONTROLLER, $this, 'share', 'index.get', $dataTables)->viewAdmin('index');
    }
    ...
    {
        return do_filter(BASE_FILTER_CONTROLLER, $dataTables, 'share', 'index.post', $this);
    }
