...
@section('content')
    ...
    <div class="layout-2columns sidebar-right">
        <div class="column main">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="post[link_url]"
                               class="form-control"
                               value="{{ $object->link_url }}" autocomplete="off">
                    </div>
                    {{--<div class="form-group">--}}
                    {{--<label class="control-label">--}}
                    {{--<b>Icon_url</b>--}}
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', WEBED_SHARE, $object) @endphp
        </div>
        <div class="column right">
            @include('webed-core::admin._components.form-actions')
            @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', WEBED_SHARE, $object) @endphp
            <div class="box box-primary">
                <div class="box-header with-border">
