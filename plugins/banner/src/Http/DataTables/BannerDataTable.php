<?php namespace WebEd\Plugins\Banner\Http\DataTables;
...
class BannerDataTable extends AbstractDataTables
{
    /**
     ...
     * @var string
     */
    protected $screenName = 'banner';

    public function __construct()
    {
        $this->model = do_filter(FRONT_FILTER_DATA_TABLES_MODEL,Banner::select(['id', 'title', 'created_at']), $this->screenName);
    }
